...
namespace work.bacome.imapsupport
{
    ...
    public struct sURIParts : IEquatable<sURIParts>
    {
        ...
        public bool Equals(sURIParts pObject) => this == pObject;

        public override bool Equals(object pObject) => pObject is sURIParts && this == (sURIParts)pObject;
        ...
        {
            var lBuilder = new cListBuilder(nameof(sURIParts));
        ...
        public static bool operator ==(sURIParts pA, sURIParts pB)
        {
            return
                pA.mParts == pB.mParts &&
        ...
        public static bool operator !=(sURIParts pA, sURIParts pB) => !(pA == pB);
