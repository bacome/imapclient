    ...
    public partial class cIMAPClient
    {
        private partial class cSession
        {
            private class cStatus
            {
                ...
                public static cStatus Combine(cStatus pNew, cStatus pOld)
                {
                ...
                public override string ToString() => $"{nameof(cMailboxStatus)}({Messages},{Recent},{UIDNext},{UIDValidity},{Unseen},{HighestModSeq})";
            }
        }
    }
}