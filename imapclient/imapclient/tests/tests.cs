...
namespace work.bacome.imapclient
{
    public partial class cIMAPClient
    {
        ...
        private static class cTests
        {
            ...
            [Conditional("DEBUG")]
            public static void Tests(bool pQuick)
            {
                cTrace.cContext lContext = mTrace.NewRoot("cIMAPClient.cTests.Tests");
            ...
            private static void ZTestPreauthAtStartup1(cTrace.cContext pParentContext)
            {
                ...
                cIdDictionary lIdD = new cIdDictionary();
                lIdD.Name = "fred";
                lClient.ClientId = new cId(new cIdReadOnlyDictionary(lIdD));
                ...
                if (lClient.Namespaces.Personal.Count != 1 || lClient.Namespaces.Personal[0].Prefix.Length != 0 || lClient.Namespaces.Personal[0].NamespaceId.NamespaceName.Delimiter != '/') throw new cTestsException("namespace failure 1", lContext);
                if (lClient.Namespaces.OtherUsers.Count != 1 || lClient.Namespaces.OtherUsers[0].Prefix != "~" || lClient.Namespaces.OtherUsers[0].NamespaceId.NamespaceName.Delimiter != '/') throw new cTestsException("namespace failure 1", lContext);
            ...
            private static void ZTestPreauthAtStartup1_3(cTrace.cContext pParentContext)
            {
                ...
                if (lClient.Namespaces.Personal.Count != 1 || lClient.Namespaces.OtherUsers != null || lClient.Namespaces.Shared != null || lClient.Namespaces.Personal[0].NamespaceId.NamespaceName.Delimiter != null || lClient.Namespaces.Personal[0].Prefix != "") throw new cTestsException("namespace problem");
            }
            ...
            private static void ZTestPreauthAtStartup2(cTrace.cContext pParentContext)
            {
                ...
                if (lClient.Namespaces.Personal[0].NamespaceId.NamespaceName.Delimiter != '/' || lClient.Namespaces.Personal[0].Prefix != "") throw new cTestsException("namespace problem");
            ...
            private static void ZTestAuthAtStartup1(cTrace.cContext pParentContext)
            {
                ...
                try
                {
                    ...
                    bool lFailed = false;
                    try { lClient.Connect(); }
                    catch (cAuthenticationException) { lFailed = true; }
            ...
            private static void ZTestAuthAtStartup4_1(cTrace.cContext pParentContext)
            {
                ...
                try
                {
                    ...
                    {
                        if (e.URL.Host != "SERVER2" || e.URL.UserId != "user" || e.URL.MechanismName != "GSSAPI") throw new cTestsException("unexpected URL properties", lContext);
                        lFailed = true;
                    }
                    if (!lFailed) throw new cTestsException("expected connect to fail");
            ...
            private class cTestAuth1Creds : cCredentials
            {
                ...
                {
                    mSASLs.Add(new cSASLPlain("fred", "angus"));
                    mSASLs.Add(new cSASLAnonymous("fr€d"));
                }
            }
