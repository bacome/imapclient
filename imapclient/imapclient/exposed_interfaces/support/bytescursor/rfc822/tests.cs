...
namespace work.bacome.imapclient.support
{
    public partial class cBytesCursor
    {
        ...
        public static void _Tests_RFC822(cTrace.cContext pParentContext)
        {
            ...
            if (lCursor.GetRFC822HeaderName(out lString) || !lCursor.GetRFC822HeaderValue(out lByteList) || cTools.UTF8BytesToString(lByteList) != "   \t  ") throw new cTestsException("header 1.1");
            if (!lCursor.GetRFC822HeaderName(out lString) || lString != "Header" || !lCursor.SkipRFC822WSP() || !lCursor.SkipByte(cASCII.COLON) || !lCursor.GetRFC822HeaderValue(out lByteList) || cTools.UTF8BytesToString(lByteList) != "      \t       \t") throw new cTestsException("header 1.2");

            TryConstruct("Header  \t  :      \r\n        \t\r\nFred", out lCursor);
            if (!lCursor.GetRFC822HeaderName(out lString) || lString != "Header" || !lCursor.SkipRFC822WSP() || !lCursor.SkipByte(cASCII.COLON) || !lCursor.GetRFC822HeaderValue(out lByteList) || cTools.UTF8BytesToString(lByteList) != "              \t") throw new cTestsException("header 2.1");

            TryConstruct("Header:\r\n  this  is  \r\n   the\tvalue     \t\r\n", out lCursor);
            if (!lCursor.GetRFC822HeaderName(out lString) || lString != "Header" || lCursor.SkipRFC822WSP() || !lCursor.SkipByte(cASCII.COLON) || !lCursor.GetRFC822HeaderValue(out lByteList) || cTools.UTF8BytesToString(lByteList) != "  this  is     the\tvalue     \t") throw new cTestsException("header 3.1");

            TryConstruct("Header:\r\n   should   \r\n    fail    \t\r\n more stuff", out lCursor);
            if (!lCursor.GetRFC822HeaderName(out lString) || lString != "Header" || lCursor.SkipRFC822WSP() || !lCursor.SkipByte(cASCII.COLON) || lCursor.GetRFC822HeaderValue(out lByteList)) throw new cTestsException("header 4.1");
            ...
            if (!lCursor.GetRFC822HeaderValue(out lByteList) || cTools.UTF8BytesToString(lByteList) != "[    [   ]   ") throw new cTestsException("domain literal 1.6");
            ...
            if (!lCursor.GetRFC822HeaderValue(out lByteList) || lByteList.Count != 0) throw new cTestsException("domain 1.4");
            ...
            if (!lCursor.GetRFC822HeaderValue(out lByteList) || cTools.UTF8BytesToString(lByteList) != ".    []         ") throw new cTestsException("local part 2.2");
