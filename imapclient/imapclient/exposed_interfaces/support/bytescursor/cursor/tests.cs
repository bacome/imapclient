...
namespace work.bacome.imapclient.support
{
    public partial class cBytesCursor
    {
        public static partial class cTests
        {
            ...
            {
                var lContext = pParentContext.NewGeneric($"{nameof(cBytesCursor)}.{nameof(cTests)}.{nameof(Tests)}");
                ...
                ZCapabilityTests(lContext);
                ZSequenceSetTests(lContext);
            ...
            public static cBytesCursor MakeCursor(params string[] pLines)
            {
