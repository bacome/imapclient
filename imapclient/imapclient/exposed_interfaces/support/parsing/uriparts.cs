    ...
    public class cURIParts
    {
        ...
        public static class cTests
        {
            ...
            public static void Tests(cTrace.cContext pParentContext)
            {
                ...
                if (!ZTryParse("HTTP://user;AUTH=GSSAPI@SERVER2/", out lParts, lContext)) throw new cTestsException("should have succeeded 5", lContext);
                ...
                if (!ZTryParse("IMAP://fr%E2%82%aCd@fred.com:123456789123456", out lParts, lContext)) throw new cTestsException("should have succeeded 8", lContext);
                ...
                if (!ZTryParse("http://www.ics.uci.edu/pub/ietf/uri/#Related", out lParts, lContext)) throw new cTestsException("URI.15");
                ...
                if (!ZTryParse("http://www.ics.uci.edu/pub/ietf/uri/historical.html#WARNING", out lParts, lContext)) throw new cTestsException("URI.16");
            ...
            public static bool ZTryParse(string pURL, out cURIParts rParts, cTrace.cContext pParentContext)
            {
