...
namespace work.bacome.imapclient
{
    public abstract class cSectionCacheItem
    {
        ...
        internal void SetHandle(cSectionHandle pSectionHandle)
        {
            if (mCached || mSectionId != null || mSectionHandle != null) throw new InvalidOperationException();
            mSectionHandle = pSectionHandle;
            mUIDNotSticky = pSectionHandle.MessageHandle.MessageCache.MailboxHandle.SelectedProperties.UIDNotSticky ?? true;
        }
