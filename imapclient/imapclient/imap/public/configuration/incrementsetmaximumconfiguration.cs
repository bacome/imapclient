...
{
    /// <summary>
    /// Contains an operation specific timeout, cancellation token, progress-setmaximum and two progress-increment callbacks.
    /// </summary>
    /// <remarks>
    /// The first-pass progress-increment is called, possibly many times, before the progress-setmaximum
    /// </remarks>
    /// <inheritdoc cref="cAPIDocumentationTemplate.Event" select="remarks"/>
    public class cIncrementSetMaximumConfiguration : cIncrementConfiguration
    {
        /// <summary>
