...
namespace work.bacome.imapclient
{
    ...
    public class cSort : IEquatable<cSort>, IComparer<iMessageHandle>, IComparer<cIMAPMessage>
    {
        /// <summary>
        ...
        /// <seealso cref="cMailbox.Messages(IEnumerable{iMessageHandle}, cMessageCacheItems, cFetchCacheItemConfiguration)"/>
        ...
        /// </remarks>
        public int Compare(cIMAPMessage pX, cIMAPMessage pY)
        {
            if (pX == null)
            {
                if (pY == null) return 0;
        ...
        /// </summary>
        /// <param name="rSortDisplay">Gets set to <see langword="true"/> if <see cref="cIMAPCapabilities.SortDisplay"/> must be in use for the server to do the sort.</param>
