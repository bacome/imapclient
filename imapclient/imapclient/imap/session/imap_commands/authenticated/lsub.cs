...
namespace work.bacome.imapclient
{
    public partial class cIMAPClient
    {
        ...
        {
            private static readonly cCommandPart kLSubCommandPart = new cTextCommandPart("LSUB \"\" ");

            public async Task<IEnumerable<iMailboxHandle>> LSubAsync(cMethodControl pMC, string pListMailbox, char? pDelimiter, cMailboxPathPattern pPattern, bool pHasSubscribedChildren, cTrace.cContext pParentContext)
            {
