    ...
    public partial class cIMAPClient
    {
        private partial class cSession
        {
            private class cCommandHook : iTextCodeProcessor
            {
                ...
                public virtual void ProcessTextCode(eIMAPResponseTextContext pTextContext, cResponseData pData, cTrace.cContext pParentContext) { }
                public virtual void ProcessTextCode(eIMAPResponseTextContext pTextContext, cByteList pCode, cByteList pArguments, cTrace.cContext pParentContext) { }
                
                // called on getting command completion from the server => it is a safe place to resolve MSNs
                public virtual void CommandCompleted(cIMAPCommandResult pResult, cTrace.cContext pParentContext) { }
            }
        }
    }
}
