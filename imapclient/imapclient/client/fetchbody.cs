    ...
    public partial class cIMAPClient
    {
        ...
        private async Task ZFetchAsync(cMailboxId pMailboxId, iMessageHandle pHandle, cSection pSection, eDecodingRequired pDecoding, Stream pStream, cTrace.cContext pParentContext)
        {
            ...
            try
            {
                ...
                if (pHandle.UID != null) await lSession.UIDFetchAsync(lMC, pMailboxId, pHandle.UID, pSection, lCapability, pDecoding, pStream, lContext).ConfigureAwait(false);
                await lSession.FetchAsync(lMC, pMailboxId, pHandle, pSection, lCapability, pDecoding, pStream, lContext).ConfigureAwait(false);
            }
