...
namespace work.bacome.imapclient
{
    public partial class cIMAPClient
    {
        ...
        /// <summary>
        /// Gets and sets the sort that is used by default when message lists are generated using <see cref="cMailbox.Messages(cFilter, cSort, cCacheItems, cMessageFetchConfiguration)"/>.
        /// </summary>
