...
namespace work.bacome.imapclient
{
    public partial class cBytesCursor
    {
        ...
        public bool GetMailboxDelimiter(out byte? rDelimiter)
        {
            ...
            if (cMailTools.IsValidDelimiter(lDelimiter)) { rDelimiter = lDelimiter; return true; }
        ...
        {
            if (SkipBytes(kRFCMonth.aJan)) rMonth = 1;
            else if (SkipBytes(kRFCMonth.aFeb)) rMonth = 2;
            else if (SkipBytes(kRFCMonth.aMar)) rMonth = 3;
            else if (SkipBytes(kRFCMonth.aApr)) rMonth = 4;
            else if (SkipBytes(kRFCMonth.aMay)) rMonth = 5;
            else if (SkipBytes(kRFCMonth.aJun)) rMonth = 6;
            else if (SkipBytes(kRFCMonth.aJul)) rMonth = 7;
            else if (SkipBytes(kRFCMonth.aAug)) rMonth = 8;
            else if (SkipBytes(kRFCMonth.aSep)) rMonth = 9;
            else if (SkipBytes(kRFCMonth.aOct)) rMonth = 10;
            else if (SkipBytes(kRFCMonth.aNov)) rMonth = 11;
            else if (SkipBytes(kRFCMonth.aDec)) rMonth = 12;
