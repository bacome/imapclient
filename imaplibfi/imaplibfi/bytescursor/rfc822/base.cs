...
namespace work.bacome.imapinternals
{
    public partial class cBytesCursor
    {
        ...
        {
            // it is unclear from the RFC whether the white space forms a semantic part of the domain-literal or whether it should be ignored
            //  this routine ignores it at the begining and end of the domain-literal content (the bytes between the brackets) but includes a
            //  single space in the result if it finds FWS embedded in the domain-literal content
            ...
            while (true)
            {
                ...
                else if (lFoundWSP) lResult.Add(cASCII.SPACE);
