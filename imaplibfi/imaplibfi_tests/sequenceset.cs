...
{
    [TestClass]
    public class Test_cSequenceSet
    {
        [TestMethod]
        public void cSequenceSet_Includes_Tests()
        {
        ...
        [TestMethod]
        public void cSequenceSet_LimitingFactory_Tests()
        {
        ...
        [TestMethod]
        public void cSequenceSet_FromUInts_Tests()
        {
        ...
        [TestMethod]
        public void cSequenceSet_FromUInts_Visual_Tests()
        {
            var lContext = kTrace.Root.NewMethod(nameof(Test_cSequenceSet), nameof(cSequenceSet_FromUInts_Visual_Tests));
            for (int i = 0; i < 100; i++) ZTestRandom(1, 99, 50, lContext);
        }


        [TestMethod]
        public void cSequenceSet_FromUInts_Speed_Test()
        {
        ...
        {
            var lContext = pParentContext.NewMethod(nameof(Test_cSequenceSet), nameof(ZTestRandom), pMinValue, pMaxValue, pCount);
